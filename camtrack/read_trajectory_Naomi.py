# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Plots various quantities along an air mass trajectory 
#
# - Reads in all trajectories from a .traj file, 
# - Selects a given trajectory, 
# - Pulls out quantities from netcdf files that correspond to the trajectory's 
# lat/lon location and time
# - Creates contour plots and line plots of quantities along the trajectory
# - Creates a map of the lat/lon trajectory
#
# Last updated: 20180903, Naomi Wharton
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

# to find variable names in a netcdf files, use  
# $ ncdump -h file.nc > header.txt
# if this does not work try first: $ export HDF5_DISABLE_VERSION_CHECK=1
# or use ncview

# before starting, and only once: after installing anaconda, need to
# give the commands in a terminal:
...
# ---------------------------------------
# use linear interpolation to estimate data values
# if false, will take values from the closest lat/lon
# ---------------------------------------
linear_interpolation = False

# ---------------------------------------
# plot CONTOUR plots along trajectory
# ---------------------------------------
make_contour_plots = True

# save to pdf
save_contour_plots_as_pdf = True

# filename to save pdf
contour_filename = 'Output/contour_plots.pdf'

# ---------------------------------------
# plot LINE plots along trajectory
# ---------------------------------------
make_line_plots = True

# save to pdf
save_line_plots_as_pdf = True

# filename to save pdf
line_plots_filename = 'Output/line_plots.pdf'


# ---------------------------------------
# plot lat/lon trajectory on a map
# ---------------------------------------
plot_map = True
...
# filename to save map pdf
map_filename = 'Output/map.pdf';
...
##########################################################################
    ...
    an air mass every hour for a period of time. 
    '''
