...
CAT_3D_NEAREST_ASC = ClimateAlongTrajectory(SAMPLE_CAM, SAMPLE_TRAJ, TRAJ_NUMBER, VARIABLES_3Dto1D, 'nearest', ASCENDING_PRESSURES)
...
UWIND_NEAREST_3DTO1D = np.array([6.323111, 5.072704])
UWIND_LINEAR_3DTO1D = np.array([7.5010892, 5.57260969])
...
# REMOVED; current version does not have 3-D -> column interpolation
